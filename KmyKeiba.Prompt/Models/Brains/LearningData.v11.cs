...
namespace KmyKeiba.Prompt.Models.Brains
{
  class LearningDatav11
  {
    ...
    public static async Task<LearningDatav11> CreateAsync(MyContextBase db, RaceData race, RaceHorseData horse, IEnumerable<(RaceData Race, RaceHorseData Horse)> horseHistories, IEnumerable<(RaceData Race, RaceHorseData Horse)> otherHorseHistories)
    {
