...
namespace KmyKeiba.Prompt.Models.Brains
{
  class LearningDatav17
  {
    ...
    public static async Task<LearningDatav17> CreateAsync(MyContextBase db, RaceData race, RaceHorseData horse, IEnumerable<(RaceData Race, RaceHorseData Horse)> horseHistories, IEnumerable<(RaceData Race, RaceHorseData Horse)> otherHorseHistories)
    {
