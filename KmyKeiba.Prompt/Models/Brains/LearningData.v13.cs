...
namespace KmyKeiba.Prompt.Models.Brains
{
  class LearningDatav13
  {
    ...
    public static async Task<LearningDatav13> CreateAsync(MyContextBase db, RaceData race, RaceHorseData horse, IEnumerable<(RaceData Race, RaceHorseData Horse)> horseHistories, IEnumerable<(RaceData Race, RaceHorseData Horse)> otherHorseHistories)
    {
