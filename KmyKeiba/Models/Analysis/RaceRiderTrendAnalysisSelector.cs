...
namespace KmyKeiba.Models.Analysis
{
  public class RaceRiderTrendAnalysisSelector : TrendAnalysisSelector<RaceRiderTrendAnalysisSelector.Key, RaceRiderTrendAnalyzer>
  {
    ...
    public RaceRiderTrendAnalysisSelector(MyContext db, RaceData race, RaceHorseData horse) : base(db, typeof(Key))
    {
      this.Race = race;
    ...
    protected override async Task InitializeAnalyzerAsync(MyContext db, RaceRiderTrendAnalyzer analyzer)
    {
      var query = db.Races!
